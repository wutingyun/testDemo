...
public class EventCase2 {
	/**
	 * 问题处理测试用例： 网格长登录，上报问题，完成之后，点击“结案”。
	 * 该用例以显式等待的方式，局部等待，只生效一次。
	 */
	...
	public void wgz_zjiean() {
		...
		shangbaoxinzeng.addZiJieAn2(title, shifadizhi, wentimiaoshu, scfujian, jieAnContent);
		// 在已处理问题页面，验证是否自结案成功。
